...
public class Cliente {
    ...
    public Cliente(int idCliente, int dni, String apellido, String nombre, String direccion, int telefono, String altClie, int altTel, boolean estado) {
    ...
    public Cliente(int dni, String apellido, String nombre, String direccion, int telefono, String altClie, int altTel, boolean estado) {
        this.dni = dni;
        this.apellido = apellido;
        this.nombre = nombre;
        this.direccion = direccion;
